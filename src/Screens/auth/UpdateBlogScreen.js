...
const UpdateBlogScreen = () => {
  ...
  return (
    <>
    <HeaderComponent/>
    <div className="p-6 dark:bg-black w-full h-full">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
          <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg w-1/2">
            <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Update Blog</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="ml-4 bg-gray-300 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-400 dark:hover:bg-gray-600"
              >
                Cancel
              </button>
            </form>
